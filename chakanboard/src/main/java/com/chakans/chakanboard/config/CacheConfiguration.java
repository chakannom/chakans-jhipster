package com.chakans.chakanboard.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("chakanboard");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("chakanboard");
        ...
        config.getMapConfigs().put("com.chakans.chakanboard.domain.*", initializeDomainMapConfig(jHipsterProperties));
